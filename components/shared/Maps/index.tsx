...
const createCustomIcon = (color: string, name: string) => {
    return L.divIcon({
        html: `<div style="font-size: 16px; text-align: center;"><i class="fas fa-map-marker-alt" style="color: ${color}; font-size: 10px;"></i><br/><span style="font-size: 8px; white-space: nowrap; display: block; margin: 0 auto; color: black;">${name}</span></div>`,
        className: '',
    })
}
