    ...
    return (
        ...
        <section className="relative mx-auto max-w-[1180px] pt-16 px-4 sm:px-8">
            <Image
                ...
                className="w-full"
            />
            <div className="absolute left-8 top-20 sm:left-10 sm:top-40 text-white" style={{fontSize:'30px'}}>
                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold leading-tight sm:leading-none">
                    <span className="text-neutral-700">UMKM</span> GEBANG PUTIH
                </h2>
                <p className="pt-3 text-base sm:text-lg lg:text-xl text-500">
        ...
        <section className="flex flex-col sm:flex-row items-center bg-green-100 px-4 sm:px-60">
            ...
            <div className="sm:w-1/2" style={{marginLeft:'20px'}}>
                <Image
                    src={UmkmImage}
                    alt="hero-image"
                    height={320}
        ...
        <section className="w-full pb-20">
            ...
            <div className="mt-10 flex flex-col sm:flex-row h-auto sm:h-80 items-center justify-center bg-umkm bg-cover px-4 sm:px-60 py-8 sm:py-0">
                ...
                <div className="w-full sm:w-2/3 text-center text-white">
                    <h3 className="text-2xl sm:text-4xl lg:text-5xl font-bold">
                        Daftarkan UMKM Anda!!
                    </h3>
                    <p className="pt-4 sm:pt-8 text-lg sm:text-xl lg:text-2xl font-semibold">
